...
export default function NodePage() {
  const concepts = [
    {
      ...
      description: "Lets you run JavaScript code outside the browser (on servers).",
      examples: [
        "node server.js // Runs your JavaScript file",
        "npm start     // Starts your Node application"
      ]
    },
    {
      title: "Package Management",
      description: "NPM (Node Package Manager) helps install and share code libraries.",
      examples: [
        "npm install express // Adds Express framework",
        "npm run dev        // Runs development script"
      ]
    },
    {
      title: "Backend Capabilities",
      description: "Can handle file systems, databases, and network requests.",
      examples: [
  ...
  return (
    <div className="min-h-screen bg-black text-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      {/* Same header structure as React page */}
      <header className="text-center mb-16">
        <div className="flex justify-center items-center mb-6">
          <FaNodeJs className="text-pink-500 text-5xl mr-3" />
