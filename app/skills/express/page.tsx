...
export default function ExpressPage() {
  const concepts = [
    ...
    {
      title: "Routing",
      description: "Defines how your app responds to client requests at different URLs.",
      examples: [
    ...
    {
      title: "Middleware",
      description: "Functions that have access to request and response objects.",
      examples: [
    ...
    <div className="min-h-screen bg-black text-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <header className="text-center mb-16">
        <div className="flex justify-center items-center mb-6">
          <SiExpress className="text-pink-500 text-5xl mr-3" />
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto">
          Fast, unopinionated backend framework for Node.js
        </p>
      </header>
        ...
        {concepts.map((concept, index) => (
          <div key={index} className="bg-gray-900 rounded-xl p-6 border-l-4 border-pink-500">
            <div className="flex items-start mb-4">
              <FaRoute className="text-pink-400 mt-1 mr-3 flex-shrink-0" />
              <div>
